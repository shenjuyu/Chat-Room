...
public class Client implements Runnable {
	...
	private Button button_3;/*清空消息按钮*/
	private List list;/*在线用户列表*/
	...
	protected void createContents() {
		...
		Label lblNewLabel_1 = new Label(sashForm_3, SWT.NONE);
		lblNewLabel_1.setText("在线用户");
		
		list = new List(sashForm_3, SWT.BORDER);
		sashForm_3.setWeights(new int[] {29, 335});
